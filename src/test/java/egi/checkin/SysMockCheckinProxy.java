...
public class SysMockCheckinProxy implements QuarkusTestResourceLifecycleManager {

    private static final Logger log = Logger.getLogger(SysMockCheckinProxy.class);
    private static boolean logRequestBody = false;

    private SysMockCheckin mockCheckin;
    ...
    public Map<String, String> start() {
        ...
        //logRequestBody = true;
        mockCheckin = new SysMockCheckin(options()
                            .port(9091)
        ...
        mockCheckin.addMockServiceRequestListener(SysMockCheckinProxy::requestReceived);
