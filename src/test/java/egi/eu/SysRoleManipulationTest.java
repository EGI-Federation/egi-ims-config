...
import egi.checkin.SysMockCheckin;
...
import egi.checkin.SysMockCheckinProxy;


@QuarkusTest
@QuarkusTestResource(SysMockCheckinProxy.class)
public class SysRoleManipulationTest {
    ...
    private static final Logger log = Logger.getLogger(SysRoleManipulationTest.class);
